...
class Request extends Component {
    ...
    render () {
        ...
        let instructions = (
            !this.props.token ? <h3 className={classes.subtitle}>Please go to the Login page to create an account or sign in before ordering.</h3> : null
        );
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onRequestSubmit: (orderData) => dispatch(actions.setRequest(orderData))
    };
};

export default connect(mapStateToProps, mapDispatchToProps)(withErrorHandler(Request, axios));